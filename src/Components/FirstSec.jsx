...
const FirstSec = () => {
    return (
        <div className='h-[300px] mt-20 lg:mt-36 p-4 bg-rose-50 lg:w-[68%] lg:container mx-auto'>
            <div className='flex justify-evenly border items-center lg:p-20 border-red-300 h-full'>
                ...
                <img className='w-[250px] h-[250px]' src={author} alt="" />
            </div>
        </div>
    );
};
