...
const SecondSec = () => {
    return (
        <div className='container text-red-400 text-center gap-20 mx-auto my-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
            <div className='w-[450px]'>
                <img className='w-[450px]' src={first} alt="" />
            ...
            <div className='w-[450px]'>
                <img className='w-[450px]' src={second} alt="" />
                <div className='bg-white text-red-400 relative p-4 -mt-10 italic'>
            ...
            <div className='w-[450px]'>
                <img className='w-[450px]' src={third} alt="" />
                <div className='bg-white text-red-400 relative p-4 -mt-10 italic'>
